...
function CareerList() {
    ...
    return (
        <>
        <div className='max-w-[1400px] m-auto grid grid-cols-1 md:grid-cols-3 place-items-center pt-5 pb-11'>
            <div className='col-span-1 text-[#f5f3f4] flex flex-col items-center mb-8'>
                ...
                <p className='text-center px-5 pb-5'>Tom is the owner of <strong>The Rhythm Messengers</strong> - Chicago-based Drumming and Entertainment company.</p>
            ...
            <div className='col-span-1 text-[#f5f3f4] flex flex-col items-center mb-5'>
                ...
                <p className='text-center px-5 pb-5'>Tom plays drums in the Blue Man Group Chicago.</p>
                <a>
                    <button 
            ...
            <div className='col-span-1 text-[#f5f3f4] flex flex-col items-center mb-5'>
                ...
                <p className='text-center px-10 pb-5'>Tom is the Percussion Director at Highland Park High School, and New Trier High School.</p>
                <a>
                    <button 
